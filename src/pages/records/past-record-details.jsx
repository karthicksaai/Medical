...
function PastRecordDetails() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const prompt = `You are an AI specializing in summarizing patient past medical records. Please analyze the uploaded document and summarize it in a structured format focusing on important diagnoses, treatments, medications, allergies, and other relevant information. Make it clear and readable for future medical consultations.`;
