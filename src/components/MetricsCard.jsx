...
const MetricsCard = ({
  ...
  <div className="flex flex-col rounded-xl border bg-white shadow-sm dark:border-neutral-800 dark:bg-[#9494e0]">
    <div className="flex justify-between gap-x-3 p-4 md:p-5">
      ...
      <div className="flex size-[46px] h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-blue-600 text-white dark:bg-[#1e1ea5] dark:text-blue-200">
