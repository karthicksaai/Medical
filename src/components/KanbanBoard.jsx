      ...
      >
        <div className="m-auto flex gap-4">
          ...
          <button
            ...
            className="flex h-[60px] w-[350px] min-w-[350px] cursor-pointer gap-2 rounded-lg border-2 border-columnBackgroundColor bg-[#7FB3D5] p-4 ring-green-500 hover:ring-2"
          >
            <IconPlus />
            Add Column
          </button>
